...
class DemoCallback(pl.Callback):
    ...
    def on_train_batch_end(self, trainer, module, outputs, batch, batch_idx):        
        ...
        try:
            ...
            torchaudio. save(
                os.path.join(
                output_dir, final_filename), fakes, self.sample_rate
            )

            log_dict[f'demo'] = wandb.Audio(os.path.join(output_dir, final_filename),
...
def main():
    ...
    diffusion_trainer = pl.Trainer(
        ...
        # strategy='ddp',
        # NOTE: default here is half precision (16)
        #full precision (32)
